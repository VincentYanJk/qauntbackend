...
strategy_params = {
    ...
    'momentum_threshold': 0,     # Momentum must be positive
    'vol_ratio_threshold': 0,    # Volume ratio must be positive
...
print("2. 5-day/10-day volume ratio > 1")
print("3. RSI < 30 (oversold)")
print("\nSell Signal Conditions:")
print("1. 5-day momentum <= 0 OR")
print("2. 5-day/10-day volume ratio <= 1 OR")
